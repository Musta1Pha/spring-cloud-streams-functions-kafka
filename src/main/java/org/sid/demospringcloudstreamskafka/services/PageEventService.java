...
public class PageEventService {
    ...
    @Bean
    // Comportement par defaut de type supplier
    // C'est que chaque seconde il envoie un event
    public Supplier<PageEvent> pageEventSupplier(){
        return ()-> new PageEvent(Math.random()>0.5?"P1":"P2",Math.random()>0.5?"U1":"U2",new Date(),new Random().nextLong(9000));
    }
